...
WORLD_DATABASE: List[WorldMetadata] = [
    ...
    WorldMetadata(
        ...
        description="A cafe environment with tables, chairs, walking actors, and outdoor seating. Good for service robot simulation.",
        source_repo="gazebosim/gazebo-classic",
        ...
        terrain_type=TerrainType.FLAT,
        simulator_compatibility=SimulatorCompatibility.GAZEBO_CLASSIC,
        semantic_features=["cafe", "restaurant", "tables", "chairs", "service", "food", "counter", "actors"],
        complexity_score=4,
    ),
    ...
    WorldMetadata(
        id="heightmap_world",
        name="Heightmap World",
        description="A terrain with heightmap elevation. Good for testing robots on varied terrain.",
        source_repo="gazebosim/gazebo-classic",
        source_url="https://github.com/gazebosim/gazebo-classic",
        ...
        simulator_compatibility=SimulatorCompatibility.GAZEBO_CLASSIC,
        semantic_features=["heightmap", "terrain", "slopes", "elevation", "hills", "outdoor"],
        complexity_score=3,
    ),
]
